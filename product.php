				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price"><i class="fa fa-inr"></i>'.$row['product_price'].'<del class="product-old-price"><i class="fa fa-inr"></i>990.00</del></h3>
                        ...
                        echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'><i class='fa fa-inr'></i>$pro_price<del class='product-old-price'><i class='fa fa-inr'></i>990.00</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
